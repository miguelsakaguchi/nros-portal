# Consuming NROS Design System in Expo apps

Read `artifacts/nros-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/nros-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/nros-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/nros-design-system/lib/native-theme";
import { useColors } from "@workspace/nros-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/nros-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/nros-design-system/components/native/badge";
import { Button } from "@workspace/nros-design-system/components/native/button";
import { Card } from "@workspace/nros-design-system/components/native/card";
```
...
Import and render
`@workspace/nros-design-system/components/native/button`, then run Expo
