# Migrating web UI to NROS Design System

Read `artifacts/nros-design-system/docs/AGENTS.md` and
`artifacts/nros-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/nros-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/nros-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/nros-design-system/hooks/use-toast`
