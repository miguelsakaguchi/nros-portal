# Consuming NROS Design System in web apps

Read `artifacts/nros-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/nros-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/nros-design-system/styles.css";
```
...
`node_modules/@workspace/nros-design-system/src/components` to `content`.
...
import { cn } from "@workspace/nros-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/nros-design-system/hooks/use-toast";
```
...
`@workspace/nros-design-system/components/ui/button`. Run the app's typecheck
