...
const RiskBadgeDemo = lazyPage(() =>
  import('./demos/risk-badge').then(({ RiskBadgeDemo }) => RiskBadgeDemo),
);
const MetricCardDemo = lazyPage(() =>
  import('./demos/metric-card').then(({ MetricCardDemo }) => MetricCardDemo),
);
const AIInsightCardDemo = lazyPage(() =>
  import('./demos/ai-insight-card').then(({ AIInsightCardDemo }) => AIInsightCardDemo),
);
const RiskMatrixDemo = lazyPage(() =>
  import('./demos/risk-matrix').then(({ RiskMatrixDemo }) => RiskMatrixDemo),
);
const MobileAssessmentDemo = lazyPage(() =>
  import('./demos/mobile-assessment').then(({ MobileAssessmentDemo }) => MobileAssessmentDemo),
);
...
export const DESIGN_SYSTEM = {
  title: 'NROS Design System',
  description:
    'Linguagem visual para transformar dados psicossociais em insights, recomendações e ações com clareza e segurança.',
} as const;
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    entries: [
      {
        id: 'nros-principles',
        name: 'Princípios NROS',
        description: 'Dados, análise, insight, recomendação e ação.',
        Page: OverviewPage,
      },
    ],
  },
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        id: 'risk-badge',
        name: 'Risk badge',
        description: 'Estados semânticos de risco psicossocial.',
        Page: RiskBadgeDemo,
      },
      {
        id: 'metric-card',
        name: 'Metric card',
        description: 'Indicadores executivos com tendência e prioridade.',
        Page: MetricCardDemo,
      },
      {
        id: 'risk-matrix',
        name: 'Risk matrix',
        description: 'Probabilidade, severidade e seleção de riscos.',
        Page: RiskMatrixDemo,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Insight contextualizado com evidência e recomendação.',
        Page: AIInsightCardDemo,
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        description: 'Perguntas anônimas com baixo esforço cognitivo.',
        Page: MobileAssessmentDemo,
      },
    ],
  },
  {
